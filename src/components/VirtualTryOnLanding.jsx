          ...
          <div className="bg-gradient-to-br from-esbelta-cream to-white rounded-2xl shadow-2xl p-8">
            ...
            <div className="space-y-4">
              ...
              <a
                ...
                className="block w-full py-4 px-6 rounded-full bg-[#F88379] text-white font-bold text-lg hover:bg-[#e07269] hover:shadow-2xl hover:scale-105 transition-all text-center"
              >
