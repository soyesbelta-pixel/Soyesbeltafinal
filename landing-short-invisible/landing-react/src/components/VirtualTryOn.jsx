...
import { generateTryOnImages } from '../services/geminiImageService';
...
const PRODUCTS = [
  {
    ...
    imageUrl: '/images/beneficios/short-invisible.png', // Imagen para Gemini y frontend
    color: 'beige'
  },
  {
    id: 2,
    ...
    imageUrl: '/images/short-negro-1.png', // Imagen para Gemini y frontend
    color: 'negro'
  }
];
            ...
            <form onSubmit={handleContactSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-esbelta-coral transition-all ${
                    contactErrors.email ? 'border-red-400' : 'border-esbelta-sand'
                  }`}
            ...
            <div className="bg-white rounded-xl p-6 mb-8">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="text-center">
                  <img src="/images/cliente1.jpeg" alt="Cliente" className="w-16 h-16 rounded-full mx-auto mb-2 object-cover" />
                ...
                <div className="text-center">
                  <img src="/images/cliente2.jpeg" alt="Cliente" className="w-16 h-16 rounded-full mx-auto mb-2 object-cover" />
                ...
                <div className="text-center">
                  <img src="/images/cliente3.jpeg" alt="Cliente" className="w-16 h-16 rounded-full mx-auto mb-2 object-cover" />
